...
export default function Hero({ isReferrer }: HeroProps) {
    ...
    return (
        ...
        >
            ...
            <section
                className="block md:hidden relative min-h-screen w-full flex flex-col justify-end"
                style={{
                    minHeight: '100vh',
            ...
            <div className="hidden md:block w-full h-[600px] min-h-[600px] relative">
                {/* Background image */}
                ...
                <div className="relative z-20 flex flex-col justify-center items-start pl-24 pr-8 h-full w-full max-w-5xl">
                    <h1
                        ...
                        style={{ fontFamily: 'deuterium-variable, Inter, sans-serif', letterSpacing: '-0.01em' }}
                    >
                        Radiology that<br />puts people first
                    </h1>
                    <p
