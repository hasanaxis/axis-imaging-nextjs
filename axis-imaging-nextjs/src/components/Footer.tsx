...
export default function Footer() {
    return (
        <footer className="bg-[#2B2960] text-[#C4CED4] pt-16 pb-8 px-4" style={{ fontFamily: 'DeuteriumVariable, Inter, sans-serif' }}>
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-start gap-12">
                ...
                <div className="flex-[2] grid grid-cols-2 md:grid-cols-4 gap-8 w-full">
                    {/* Customer Support */}
                    <div>
                        <h4 className="text-white font-bold mb-3">Customer Support</h4>
                        ...
                        <h4 className="text-white font-bold mt-6 mb-2">Follow Us</h4>
                        <ul className="space-y-1">
                    ...
                    {/* Corporate */}
                    <div>
                        <h4 className="text-white font-bold mb-3">Corporate</h4>
                        <ul className="space-y-1">
                    ...
                    {/* Clinic Details */}
                    <div>
                        <h4 className="text-white font-bold mb-3">CLINICS DETAILS</h4>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span>info@axisimaging.com.au</span>
                        </div>
                    </div>
                </div>
            </div>
