    ...
    return (
        <header className="bg-[#23235B] text-white px-4 py-3 flex items-center justify-between w-full relative z-50" style={{ fontFamily: 'deuterium-variable, Inter, sans-serif' }}>
            ...
            <>
                ...
                {/* Drawer */}
                <div
                    className={`fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-[#23235B] shadow-2xl flex flex-col px-4 py-6 z-50 md:hidden transform transition-transform duration-300 ease-in-out ${menuOpen ? 'translate-x-0' : 'translate-x-full'} overflow-y-auto`}
                >
