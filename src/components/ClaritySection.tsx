...
export default function ClaritySection() {
    return (
        ...
        >
            ...
            {/* Heading */}
            <h2 className="relative z-10 text-4xl sm:text-5xl md:text-6xl font-bold text-axis-dark-purple text-center mb-12 px-4 py-6">
                We provide clarity every<br className="hidden md:block" /> step of the way
            </h2>
            {/* Cards */}
            <div className="w-full max-w-7xl flex flex-col lg:flex-row justify-center items-stretch gap-8 mb-8 px-4 relative z-10">
                {/* Card 1 */}
                <div className="flex flex-col items-center rounded-xl px-6 py-0 flex-1 bg-transparent">
                    ...
                    <h3 className="text-[#662D91] text-2xl sm:text-3xl md:text-2xl font-bold mb-2 text-center" style={{ fontFamily: 'deuterium-variable, Inter, sans-serif' }}>Book online or call us</h3>
                    <p className="text-[#3C4247] text-lg text-center" style={{ fontFamily: 'deuterium-variable, Inter, sans-serif' }}>Use our easy online booking form to choose a time that's convenient or call us.</p>
                </div>
                {/* Card 2 */}
                <div className="flex flex-col items-center rounded-xl px-6 py-0 flex-1 bg-transparent">
                    <Image src="/assets/clarity/2.png" alt="Our team will guide you" width={260} height={220} className="rounded-lg object-cover mb-6" />
                    <h3 className="text-[#662D91] text-2xl font-bold mb-2 text-center" style={{ fontFamily: 'deuterium-variable, Inter, sans-serif' }}>Our team will guide you</h3>
                    <p className="text-[#3C4247] text-lg text-center" style={{ fontFamily: 'deuterium-variable, Inter, sans-serif' }}>Our team will guide you through each step when you are at the clinic.</p>
                </div>
                {/* Card 3 */}
                <div className="flex flex-col items-center rounded-xl px-6 py-0 flex-1 bg-transparent">
                    ...
                    <h3 className="text-[#662D91] text-2xl font-bold mb-2 text-center" style={{ fontFamily: 'deuterium-variable, Inter, sans-serif' }}>Scans reported in 24 hours</h3>
                    <p className="text-[#3C4247] text-lg text-center" style={{ fontFamily: 'deuterium-variable, Inter, sans-serif' }}>You shouldn't have to wait to get your results. That's why we get back to you within 24 hours.</p>
                </div>
            </div>
