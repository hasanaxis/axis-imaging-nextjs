    ...
    return (
        ...
        >
            <div className="relative z-10 max-w-6xl mx-auto flex flex-col items-center px-4 py-10">
                <h2 className="text-white text-4xl sm:text-4xl md:text-7xl font-bold mb-2 text-center mb-4 py-6" style={{ fontFamily: 'deuterium-variable, Inter, sans-serif' }}>
                    Explore our services
                </h2>
                <p className="text-[#C4CED4] text-center mb-10 max-w-4xl text-xl py-6" style={{ fontFamily: 'deuterium-variable, Inter, sans-serif' }}>
