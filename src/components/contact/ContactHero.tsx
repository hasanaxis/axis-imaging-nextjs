                ...
                >
                    ...
                    >
                        ...
                        <div className="relative w-full flex flex-col items-start px-4 sm:px-5 pb-6 sm:pb-8 z-10 max-w-[1260px] mx-auto">
                            ...
                            >
                                Whether you’re ready to book an appointment, have a question about our services, or simply need more information, our friendly team is here to support you. At Axis Imaging, we believe in clear communication and compassionate care — so don’t hesitate to reach out. Your comfort and confidence are our priority every step of the way.                            </p>
                            <button
