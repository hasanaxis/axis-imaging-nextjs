...
export default function Features() {
    return (
        <section className="hidden lg:flex bg-[#23235B] py-13 justify-center" style={{ fontFamily: 'deuterium-variable, Inter, sans-serif' }}>
            <div className="w-full max-w-7xl flex flex-col lg:flex-row items-center justify-between min-h-[140px] px-0">
                {/* Feature 1 */}
                <div className="flex flex-col lg:flex-row items-center flex-1 min-w-0 mb-8 lg:mb-0">
                ...
                {/* Feature 3 */}
                <div className="flex flex-col lg:flex-row items-center flex-1 min-w-0 mb-0">
