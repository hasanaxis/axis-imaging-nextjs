        ...
        >
          ...
          >
            ...
            <div className="relative w-full flex flex-col items-start px-4 sm:px-5 pb-6 sm:pb-8 z-10 max-w-[1260px] mx-auto">
              ...
              >
                Ultrasound imaging uses high-frequency sound waves to create real-time images of your internal organs and tissues. This safe, non-invasive procedure provides detailed views without radiation, making it ideal for monitoring pregnancies, diagnosing conditions, and guiding medical procedures.
              </p>
              <button
