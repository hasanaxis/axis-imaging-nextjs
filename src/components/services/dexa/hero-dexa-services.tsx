        ...
        >
          ...
          >
            ...
            <div className="relative w-full flex flex-col items-start px-4 sm:px-5 pb-6 sm:pb-8 z-10 max-w-[1260px] mx-auto">
              ...
              >
                DEXA (Dual-Energy X-ray Absorptiometry) is the gold standard for measuring bone density and assessing osteoporosis risk. This quick, painless scan provides accurate measurements of your bone health, helping doctors develop personalized treatment plans to strengthen your bones.
              </p>
              <button
